...
if __name__ == "__main__":
    ...
    while not glfw.window_should_close(window):
        ...
        glUniform3f(glGetUniformLocation(lightingPipeline.shaderProgram, "Kd"), 0.2, 0.2, 0.2)
        glUniform3f(glGetUniformLocation(lightingPipeline.shaderProgram, "Ks"), 0.0, 1.0, 1.0)
